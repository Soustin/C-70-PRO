        ...
        return (
          <View style={styles.container}>
            ...
            <View style={styles.inputContainer}>
              ...
              <TouchableOpacity style={styles.scannerBTN} onPress={this.getCameraPermissions("Book Id")}>
                <Text>
                  Scan
                </Text>
              </TouchableOpacity>
            ...
            <View style={styles.inputContainer}>
              ...
              <TouchableOpacity style={styles.scannerBTN} onPress={this.getCameraPermissions("Student Id")}>
                <Text>
                  Confirm
                </Text>
              </TouchableOpacity>
